...
const jobs = [
{c:"CH",country:"Switzerland",title:"SAP SD / OTC Consultant",company:"Conexus / client project",place:"Bern · Hybrid",type:"Permanent",date:"24 Sep 2026",fit:"OTC · S/4HANA · business process",url:"https://www.conexusdx.com/job/sap-sd-slash-otc-consultant-6038674",note:"S/4HANA transformation, OTC ownership, business stakeholder work."},
{c:"CH",country:"Switzerland",title:"Senior Consultant SAP S/4HANA SD / OTC",company:"Sanitas Troesch AG",place:"Bern · 80–100%",type:"Permanent",date:"18 Sep 2026",fit:"S/4HANA · OTC · transformation",url:"https://www.jobs.ch/en/vacancies/detail/a2edbdca-0a45-4592-80e7-9b9f18955eb5/",note:"Public Cloud transformation and redesign of sales/customer processes."},
{c:"CH",country:"Switzerland",title:"Senior Consultant SAP S/4HANA SD / OTC / WMS",company:"Saint-Gobain",place:"Bern · Hybrid / onsite",type:"Permanent",date:"18 Sep 2026",fit:"SD · OTC · EWM/WMS integration",url:"https://joinus.saint-gobain.com/en/che/sal/p/67302/323924/senior-consultant-sap-s4hana-sd-order-cash-otc-wms-bern-80-100-mwd?page=0",note:"S/4HANA Cloud Public Edition and integrated sales/customer processes."},
{c:"AT",country:"Austria",title:"SAP SD Consultant",company:"International organisation",place:"Vienna · Hybrid",type:"Permanent",date:"21 Sep 2026",fit:"SAP SD · English · process improvement",url:"https://jobsinaustria.at/job/sap-sd-consultant-only-english-needed-6ab1004e7c930",note:"In-house SAP SD role covering implementation, rollout and process optimisation."},
{c:"AT",country:"Austria",title:"SAP SD/LE AMS Consultant",company:"Red Global / automotive client",place:"Austria · Remote",type:"Contract",date:"15 Sep 2026",fit:"SD · LE · support · EDI/IDoc",url:"https://redglobal.com/jobs/job/sap-sd-le-ams-consultant-automotive-logistics-remote/bN6PRQdQ",note:"Support-driven role covering tickets, shipping, pricing and EDI/IDoc."},
{c:"DE",country:"Germany",title:"SAP Solution Architect SD",company:"Michael Page / industrial client",place:"Berlin · Home Office",type:"Permanent",date:"22 May 2026",fit:"SD · OTC · S/4HANA",url:"https://www.michaelpage.de/job-detail/sap-solution-architekt-wdm-sd/ref/jn-052026-7013086",note:"International SD/OTC transformation from ECC to S/4HANA."},
{c:"UK",country:"United Kingdom",title:"Senior SAP SD/OTC Consultant",company:"Next Ventures / SAP team",place:"London · Hybrid",type:"Permanent",date:"9 Sep 2026",fit:"SD · OTC · S/4HANA · testing",url:"https://www.computerwork.com/gb/en/JobLanding.aspx?jid=66FB4803D228CF0A72&r=54624452621A669D&src=",note:"OTC optimisation, S/4HANA transformation, workshops, testing and go-live."},
{c:"UK",country:"United Kingdom",title:"SAP SD Consultant (S/4 Public Cloud)",company:"Harrington Boyd",place:"London · Hybrid",type:"Permanent",date:"29 May 2026",fit:"S/4HANA Public Cloud · SD",url:"https://www.britishjobs.co.uk/sap-sd-consultant-jobs",note:"Public Cloud SD consulting role; verify current status on the live listing."}
];
...
function renderJobs(country="all"){document.getElementById("jobsGrid").innerHTML=jobs.filter(j=>country==="all"||j.c===country).map(j=>`<article class="job-card"><div class="job-top"><span class="country">${j.country}</span><span class="muted">${j.date}</span></div><h3>${j.title}</h3><div class="company">${j.company}</div><div class="meta"><span>${j.place}</span><span>${j.type}</span><span>${j.fit}</span></div><p>${j.note}</p><a href="${j.url}" target="_blank" rel="noreferrer">Open posting / verify live status ↗</a></article>`).join("");}
renderJobs();
